...
%The ambulance is at (graph(l0).lat, graph(l0).long) at time t0
...
function [indexBase]=findBestBase(ambulances,graph,t0,l0,lambdaBase,T,nb_base,bases,indexAmb,timeAhead,times,nbpriorities,nb_ambulances,poissquant)
